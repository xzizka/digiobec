...
export type BroumyAlertVariant = 'info' | 'success' | 'warning' | 'error';

export interface BroumyAlertProps extends Omit<HTMLAttributes<HTMLDivElement>, 'className'> {
  children: ReactNode;
  /** @default 'info' */
...
/**
 * Accessible Broumy alert (citizen-web copy of the admin-web component).
